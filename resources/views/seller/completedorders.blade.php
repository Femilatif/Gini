                            ...
                            <div class="tpshop__top ml-60">
                                ...
                                <div class="tpshop__banner mb-30 bg-success">
                                    <div class="tpshop__content text-center">
                                        <h4 class="tpshop__content-title mb-20"> {{ "Completed Orders" }}</h4>
                                ...
                                <div class="tab-content " id="nav-tabContent">
                                    <div class="tab-pane fade show active whight-product" id="nav-popular" role="tabpanel"
                                        ...
                                        <h4 class="mb-3 ">Completed Orders</h4 class="mb-3">
                                        @endif
                                        ...
                                        <div
                                            ...
                                            @if ($completed_orders->isEmpty())
                                                <div class="w-100">
                                                    <p class="text-danger fs-4">No Order has been completed</p>
                                                </div>
                                            @else
                                                @foreach ($completed_orders as $product)
                                                    <div class="col">
                                                        <div class="tpproduct p-relative mb-20">
                                                            <div class="tpproduct__thumb p-relative text-center">
                                                                ...
                                                                <div class="tpproduct__info bage">
                                                                    ...
                                                                    <span class="tpproduct__info-hot bg-info badge">Completed Order</span>
                                                                </div>
                                                            ...
                                                            <div class="tpproduct__content">
                                                                <span class="tpproduct__content-weight">
                                                                    <h4 class="tpproduct__title">Order Status:
                                                                       <span class="bg-success badge badge-pill">  {{ $product->status }}</span>
                                                                    </h4>
                                                                    
                                                                </span>
                                                             
                                                                <h4 class="tpproduct__title">
                                                                    <a href="{{ route('orderdetails', $product->id) }}">Product Name:
                                                                ...
                                                                <div class="tpproduct__price">
                                                                    Purchased Cost: <span>{{ number_format($product->price) }}</span>
